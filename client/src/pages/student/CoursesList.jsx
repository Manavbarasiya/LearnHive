  ...
  return (
    <>
      <div className='relative md:px-36 px-8 pt-20 text-left'>
        ...
        {
          input && <div className='inline-flex items-center gap-4 px-4 py-2 border mt-8 -b-8 text-gray-600'>
            <p>{input}</p>
            <img src={assets.cross_icon} alt="cross_icon" onClick={()=>navigate("/course-list")}/>
            </div>
        }
        <div className='grid grdi-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 my-16 gap-3 px-2 md:p-0'>
